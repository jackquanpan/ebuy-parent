...
<div class="soubg">
	<div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="static/pages/Login.html">登录</a>&nbsp; <a href="<%=basePath%>pages/Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;</span>
            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">还没有商城账号，<a href="<%=basePath%>pages/Regist.jsp" style="color:#ff4e00;">立即注册</a></span>
                </td>
              </tr>
              <tr height="70">
                <td>用户名</td>
